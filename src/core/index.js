...
export { default as UISwipeGestureRecognizer } from './UISwipeGestureRecognizer.js';
export { default as UIFont } from './UIFont.js';
...
export { default as UICollectionReusableView } from './UICollectionReusableView.js';
export { default as UINavigationBar, UINavigationItem } from './UINavigationBar.js';
export { default as UINavigationController } from './UINavigationController.js';
export { default as UIToolbar, UIBarButtonItem } from './UIToolbar.js';
export { default as UITabBar, UITabBarItem } from './UITabBar.js';
export { default as UITabBarController } from './UITabBarController.js';
